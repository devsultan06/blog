        ...
        <div className="box flex justify-between items-start max-900:flex-col">
          <div className="item flex-1 border-r border-b border-t border-dark20  pt-[100px] max-900:pt-[50px]">
            <div className="pl-[100px] max-900:pl-[20px]">
              ...
              <p className="text-lightgrey text-[17px] mt-[5px] max-900:w-full max-700:w-[50%]">Welcome to the epicenter of AI innovation. FutureTech AI News is your passport to a world where machines think, learn, and reshape the future. Join us on this visionary expedition into the heart of AI.</p>
            </div>
